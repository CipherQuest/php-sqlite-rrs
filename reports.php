 ...
 * Print View Details
 */
$report_title = "Date-wise Queued rooms Record Reports";
...
<h1 class="text-center fw-bolder">Date-wise Queued rooms Record Reports</h1>
...
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            var report_content = $('#roomTBL').clone()
